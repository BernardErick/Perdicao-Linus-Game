...
public class DialogsOfRichard : MonoBehaviour
{
    ...
    public void change(string decisao, bool overwrite) {
        ...
        //Volta pra fase do Barbosa
         if (this.fase =="11") {
            ...
            StartCoroutine(ChangeLevel("Dissociation", 5.0f));
        }              
        if (this.fase =="10") {
    ...
    private IEnumerator ChangeLevel(string level,float seconds){
